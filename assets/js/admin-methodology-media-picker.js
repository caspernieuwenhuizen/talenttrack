                ...
                var $card = $(
                    '<div class="tt-methodology-media-staged-card" style="border:1px dashed #1a4a8a; border-radius:6px; padding:6px; background:#f0f6ff; display:flex; gap:8px; align-items:center; max-width:260px;">' +
                        ...
                        '<div style="flex:1; min-width:0;">' +
                            '<div style="font-size:12px; font-weight:600; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">' + ( att.title || 'Image' ) + '</div>' +
                            '<div style="font-size:11px; color:#5b6470;">Wordt toegevoegd bij opslaan</div>' +
                        '</div>' +
