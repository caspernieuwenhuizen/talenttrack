...
| **Attendance not recorded** | The activity is marked completed but nobody recorded who was there. A roster you planned in advance does not count — this is about the register taken on the day, so is a guest player's row. It looks finished everywhere except in the reports. |
