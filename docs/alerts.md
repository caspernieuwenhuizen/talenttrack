...
| **Attendance not recorded** | The activity is marked completed but nobody recorded who was there. It looks finished everywhere except in the reports. Ticking who was *expected* beforehand does not count — the alert is about the register you fill in afterwards, and guests are not part of it. An activity that is still planned is the previous alert's job, not this one's. |
