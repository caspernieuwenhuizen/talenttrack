...
The **Category Weights** page lets you specify how much each main category counts toward a player's overall rating, **per age group**. For example:
...
Weights must sum to 100% per age group. The system computes each player's overall rating using the weights matching their team's age group.
