...
- De **voorkeursposities van een speler wijzigen** → *"Positie: geen → Centrale verdediger, Linksback"* (posities staan er voluit, niet als code). Het positieveld leegmaken schrijft niets: er is dan geen nieuwe positie om te melden, en een regel die er een noemt meldt een bewerking in plaats van een ontwikkelmoment.
