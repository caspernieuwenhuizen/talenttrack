...
**Systeemstandaard volgt de taal van je site als de WordPress-datumnotatie nooit is gewijzigd.** WordPress schrijft die notatie één keer weg, bij de installatie, in de installatietaal — een site die in het Engels is geïnstalleerd en later op Nederlands is gezet, hield dus de Engelse volgorde en toonde Nederlandse maandnamen daarin ("oktober 6, 2026"). Op **Systeemstandaard** wordt een onaangeroerde WordPress-datumnotatie nu gelezen als "wat WordPress in deze taal schrijft", en dat geeft "6 oktober 2026" op een Nederlandse site terwijl een Engelse site precies blijft zoals hij was. Heb je de WordPress-datumnotatie *wel* zelf ingesteld, dan blijft die keuze ongewijzigd — dat is een bewuste keuze. Kies een andere preset om de volgorde zelf te bepalen, ongeacht de taal.
