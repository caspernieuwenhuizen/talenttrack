...
- **Teamplanner-kalender** (Planning-module, standaard **aan**) — het week-voor-week teamplannerbord (`?tt_view=team-planner`). Uitzetten verbergt de plannertegel en toont de onbeschikbaar-melding op de route; het aanmaken en bewerken van activiteiten blijft ongemoeid.
