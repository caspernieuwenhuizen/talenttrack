...
De vier standaard aangemaakte categorieën zijn **Technisch**, **Tactisch**, **Fysiek** en **Mentaal**. Dit zijn de standaardrubrieken waarop jouw coaches spelers beoordelen.

Je kunt er meer toevoegen, hernoemen, herordenen of deactiveren op de pagina **Evaluatiecategorieën**. Elke categorie heeft een weergavevolgorde en een actief/inactief-vlag.

## Subcategorieën

Elke hoofdcategorie kan subcategorieën hebben. Voorbeeld: Technisch → Passen, Aanname, Schieten, Dribbelen.

Als een coach een evaluatie vastlegt, kan hij/zij de hoofdcategorie rechtstreeks beoordelen OF dieper ingaan op subcategorieën voor een gedetailleerdere beoordeling. Als subcategorieën worden beoordeeld, wordt de score op de hoofdcategorie het gewogen gemiddelde.
...
Gewichten beïnvloeden de **overall-beoordeling** op rate cards en de headline cards. Individuele categoriescores blijven ongewijzigd. Historische evaluaties worden niet opnieuw opgeslagen — de overall-score wordt bij uitlezing berekend.
