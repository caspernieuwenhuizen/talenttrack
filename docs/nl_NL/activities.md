...
Twee dingen gebeuren bewust niet. Een selectie die je zelf meegeeft blijft precies zoals je hem gaf — er wordt niemand aan toegevoegd. En een selectie die je hebt **ingekort blijft ingekort**: er wordt alleen aangevuld als de selectie leeg is, dus een speler die je er bewust af hebt gehaald komt niet terug zodra er iets anders aan de activiteit verandert.
