...
The **minutes grid** records how many minutes each player got, match by match,
across a whole period — the desktop, spreadsheet-style companion to the
...
opened. The per-match minutes editor is unaffected.
