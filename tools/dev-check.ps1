...
$selfChecks = @('bin/qr-selfcheck.php', 'bin/admin-center-self-check.php', 'bin/demo-coverage-selfcheck.php', 'tools/check-demo-coverage.php', 'tools/check-module-toggles.php', 'bin/module-toggle-selfcheck.php', 'tools/check-dashboard-urls.php', 'bin/dashboard-url-selfcheck.php')
