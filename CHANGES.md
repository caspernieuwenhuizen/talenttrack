# TalentTrack v3.110.109 — Standard reports: Team + Player attendance statistics on the central Analytics surface

Second of three sequential ships from one operator round (v3.110.108 = Spond URL configurable + Analytics tile; v3.110.10X = widget library detail panel, next).
...
- `talenttrack.php` 3.110.107 → 3.110.109 (skipping 108 because the parallel ship took 107; v3.110.108 = Spond URL + Analytics tile is in flight as PR #407)
