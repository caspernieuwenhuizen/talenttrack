...
| 0060 | Persona dashboard authoring platform — 3-sprint epic complete. Sprint 1 (PR #118): foundation + 14-widget catalog + 25-KPI catalog + 8 defaults + REST + role-switcher. Sprint 2 (PR #119): drag-drop editor at `Configuration → Dashboard layouts` with draft/publish/reset, undo/redo, keyboard a11y, preview-as-persona, mobile preview, audit-log. Sprint 3 (this PR): hero data wired (rate card, today/up-next, child-switcher recap, system health, assigned players), KPI sparklines for evaluations + attendance, coach team tabs, Configuration tile entry, **flag flipped on by default**. | epic | [specs/0060-epic-persona-dashboard-templates.md](specs/0060-epic-persona-dashboard-templates.md) | ~70-95h / ~23-33h compressed |
