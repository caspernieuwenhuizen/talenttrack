...
| 0039 | Staff development module — personal goals + evaluations + certifications + PDP for coaches/scouts/staff (parallel to the player surface). Decision locked during the 2026-04-27 review: *personal-development-for-staff*, not setup-wizard-for-new-staff. Idea: [ideas/0039-feat-staff-development-module.md](ideas/0039-feat-staff-development-module.md). | feat | Goal cadence (annual + check-ins vs quarterly), reviewer model (self + top-down vs add peer), eval categories (separate root vs share player tree), certification model (flat list vs lookup-driven), workflow templates to ship | ~30-40h |
...
| 0017 | Trial player module | epic | ~72h (fully unblocked — #0014 closed in v3.40.0; #0022 Phase 1+2+3 closed in v3.37.0) |
