...
| 0056 (remainder) | Mobile-first cleanup — quick wins shipped in v3.50.0; what's left is the **Activities pilot rewrite** (full mobile-first ground-up rebuild as the reference for future surfaces) | feat | [specs/0056-feat-mobile-first-cleanup.md](specs/0056-feat-mobile-first-cleanup.md) | ~6-9h remaining |
