...
| 7 | **#0019 Sprint 3** — players + teams frontend | epic | ~22h | ~22h | **COMPLETE** | v3.9.0 = 3.1 (Players full frontend). v3.9.1 = 3.2 (Teams full + roster + sync CSV import). Sprint 4 (people + functional roles + reports) unblocked. CSV import landed as a sync version per Q1; the spec's async per-row dupe UI is deferred. |
