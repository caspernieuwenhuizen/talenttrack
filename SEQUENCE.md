...
| 0060 | Persona dashboard authoring platform — Sprint 1 (foundation + 14-widget catalog + 25-KPI catalog + 8 defaults + REST + role-switcher) shipped in PR #118 behind `persona_dashboard.enabled` flag. Sprint 2 (drag-drop editor at `Configuration → Dashboard layouts`, draft + publish + reset, undo/redo, keyboard a11y, preview-as-persona, mobile preview, audit-log) in flight. Sprint 3 = polish + flag flip. | epic | [specs/0060-epic-persona-dashboard-templates.md](specs/0060-epic-persona-dashboard-templates.md) | ~70-95h / ~23-33h compressed |
