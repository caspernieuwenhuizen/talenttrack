...
class ConfigRestController {
    ...
    private const ALLOWED_KEYS = [
        ...
        'primary_color',
        'secondary_color',
        // Branding additions from #0023 (theme_inherit removed in #1728 —
        // canvas mode now gives total isolation, no theme inheritance).
        'font_display',
        'font_body',
        ...
        'tile_appearance',
        // #1598 — academy-wide tile layout (row / stacked). Orthogonal to
        ...
        // settings; this is the default they inherit. Read through
        // ThemePreference, never directly.
        'tt_frontend_theme',
        ...
        // line across it. Un-mapped in KEY_AREA_MAP → tt_edit_settings.
        'minutes_share_target_pct',
