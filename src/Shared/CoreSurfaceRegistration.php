...
final class CoreSurfaceRegistration {
    ...
    private static function registerFrontendTiles(): void {
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Open tasks: evaluations, goals, reviews.', 'talenttrack' ),
            'icon'         => 'inbox',
            'color'        => '#5b6e75',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Completion rates and overdue tasks per coach.', 'talenttrack' ),
            'icon'         => 'kanban',
            'color'        => '#2271b1',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Enable templates; set cadence and deadline.', 'talenttrack' ),
            'icon'         => 'workflow',
            'color'        => '#5b6e75',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Per-team staff: coach, assistant, manager, physio.', 'talenttrack' ),
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Per-season files: talks, goals, verdict.', 'talenttrack' ),
            'icon'         => 'goals',
            'color'        => '#1d7874',
        ]);
        TileRegistry::register([
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Track prospects: dates, input and decisions.', 'talenttrack' ),
            'icon'         => 'track',
            'color'        => '#c9962a',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Prospect-to-offer funnel across six stages.', 'talenttrack' ),
            'icon'         => 'kanban',
            'color'        => '#2271b1',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Plan and log scouting visits to spot prospects.', 'talenttrack' ),
            'icon'         => 'calendar',
            'color'        => '#2271b1',
            'cap'          => 'tt_view_prospects',
        ]);
        TileRegistry::register([
            ...
            'description'  => __( 'Edit default templates for new trial cases.', 'talenttrack' ),
            'icon'         => 'categories',
            'color'        => '#5b6e75',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Customize admit/decline letter wording per locale.', 'talenttrack' ),
            'icon'         => 'docs',
            'color'        => '#5b6e75',
            'cap'          => 'tt_manage_trials',
            'desktop_preferred' => true,
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Player progress, team ratings, coach activity.', 'talenttrack' ),
            'icon'         => 'reports',
            'color'        => '#00a32a',
            'cap'          => 'tt_view_reports',
        ]);
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Bulk exports: players, attendance, goals, more.', 'talenttrack' ),
            'icon'         => 'docs',
            'color'        => '#0b3d2e',
            'cap'          => 'tt_view_reports',
        ]);
        ...
        TileRegistry::register([
            ...
            'feature'      => 'cohort_transitions',
            'group'        => $analytics_group,
            'kind'         => 'work',
            'order'        => 40,
            'label'        => __( 'Cohort transitions', 'talenttrack' ),
            'description'  => __( 'Find players by journey event and date range.', 'talenttrack' ),
            'icon'         => 'inbox',
            'color'        => '#0d9488',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Spotted a bug or idea? Send it to the team.', 'talenttrack' ),
            'icon'         => 'lightbulb',
            'color'        => '#c9962a',
            'cap'          => 'tt_submit_idea',
        ]);
        TileRegistry::register([
            ...
            'description'  => __( 'Kanban board of every staged idea.', 'talenttrack' ),
            'icon'         => 'kanban',
            'color'        => '#7c3a9e',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Approve and promote ideas, or reject them.', 'talenttrack' ),
            'icon'         => 'approval',
            'color'        => '#1d7874',
            'cap'          => 'tt_promote_idea',
        ]);
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Toggle record wizards; see completion stats.', 'talenttrack' ),
            'icon'         => 'lightbulb',
            'color'        => '#5b6e75',
        ...
        TileRegistry::register([
            ...
            'description'  => __( 'Open goals, overdue reviews, expiring certs.', 'talenttrack' ),
            'icon'         => 'reports',
            'color'        => '#2271b1',
