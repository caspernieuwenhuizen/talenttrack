    ...
    private static function map(): array {
        return [
            ...
            'TT\\Modules\\Media\\MediaModule' => [
                ...
                'description' => __( 'Photos and video attached to players, teams and activities. Files are stored privately and are only visible to staff around the player and to the player\'s own family. Turn off to keep photographs out of the academy entirely.', 'talenttrack' ),
                'icon'        => 'players',
                'category'    => self::CAT_PLAYER,
            ],
