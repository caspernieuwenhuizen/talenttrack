...
final class BackLabelResolver {
    ...
    private static function listLabel( string $tt_view ): string {
        switch ( $tt_view ) {
            ...
            case 'potential-overview':        return __( 'Back to Potential overview', 'talenttrack' );
            ...
            case 'safeguarding-broadcast': return __( 'Back to Safeguarding broadcast', 'talenttrack' );
