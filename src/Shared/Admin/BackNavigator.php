...
class BackNavigator {
    ...
    private const MAP = [
        ...
        'tt-sessions'           => [ 'parent_page' => 'talenttrack',       'label_key' => 'Sessions' ],
        'tt-sessions|new'       => [ 'parent_page' => 'tt-sessions',       'label_key' => 'New Session' ],
        'tt-sessions|edit'      => [ 'parent_page' => 'tt-sessions',       'label_key' => 'Edit Session' ],
    ...
    private static function labels(): array {
        return [
            ...
            'New Session'              => __( 'New Session', 'talenttrack' ),
            'Edit Session'             => __( 'Edit Session', 'talenttrack' ),
